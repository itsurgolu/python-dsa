...
if(grade.isupper()):
    totalsalary=salary+(20/100)*salary+(50/100)*salary+1700-(11/100)*salary
elif(grade.islower()):
    totalsalary = salary + (20 / 100) * salary + (50 / 100) * salary + 1500 - (11 / 100) * salary
else:
    totalsalary = salary + (20 / 100) * salary + (50 / 100) * salary + 1300 - (11 / 100) * salary
print("Total Salary is Rs=",totalsalary)
